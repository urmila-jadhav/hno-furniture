...
public function create()
{
    ...
    //     $faqsQ = json_encode($request->f_que);
    //     $faqsA = json_encode($request->f_ans);

    //     // Multiple images
    //     $images = [];
    //     if ($request->hasFile('multiple_img')) {
    //         foreach ($request->file('multiple_img') as $image) {
    ...
    //             $bName = time().'_'.$banner->getClientOriginalName();
    //             $banner->move(public_path('uploads/products'), $bName);
    //             $banners[] = 'uploads/products/'.$bName;
    //         }
    //     }
...
//     // -------------------------------------------------------
//     $faqs = [];
//     if ($request->f_que && $request->f_ans) {
//         foreach ($request->f_que as $i => $question) {
//             if (!empty($question) && !empty($request->f_ans[$i])) {
//                 $faqs[] = [
//                     'question' => $question,
//                     'answer' => $request->f_ans[$i]
//                 ];
//             }
//         }
//     }
...
//         'f_que'             => json_encode($faqs),  // <-- combined Q/A JSON
...
public function store(Request $request)
{
    ...
    //     $images = json_decode($product->multiple_img ?? '[]', true);
    //     if ($request->hasFile('multiple_img')) {
    //         foreach ($request->file('multiple_img') as $image) {
    ...
    //     $banners = json_decode($product->banner ?? '[]', true);
    //     if ($request->hasFile('banner')) {
    //         foreach ($request->file('banner') as $banner) {
    //             $name = time().'_'.$banner->getClientOriginalName();
    //             $banner->move(public_path('uploads/products'), $name);
    //             $banners[] = 'uploads/products/'.$name;
    //         }
    //     }
